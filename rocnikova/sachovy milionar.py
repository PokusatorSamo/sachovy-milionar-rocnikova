...
class ChessMilionaireGame:
    def __init__(self):
        ...
        self.questions = [
            ...
            {"question": "Ako sa nazýva keď sa kráľ posunie o dve políčka a veža ho preskočí?", "image": "rosada.jpg", "options": ["Je to nemožné", "En-passant","En-croissant", "Rošáda"], "correct_option": "Rošáda"},
            {"question": "Na ktoré políčko môže ísť dáma najďalej?", "image": "pozicia_dama.jpg", "options": ["   h8", "   a8", "   g7","   h1"], "correct_option": "   h8"},
            {"question": "Akú hodnotu majú tieto figúrky dokopy?", "image": "hodnota_figur.jpg", "options": ["   14", "   15","   20", "   9"], "correct_option": "   14"},
            {"question": "Ako sa nazýva otvorenie na obrázku, známe aj vďaka filmu/seriálu?", "image": "damsky_gambit.jpg", "options": ["Dámsky gambit", "Pešiakova obeta","Španielska hra", "Kráľova pomsta"], "correct_option": "Dámsky gambit"},
            {"question": "Ktorý veľmajster sa nachádza na obrázku?", "image": "carlsen.jpg", "options": ["Garry Kasparov", "Viswanathan Anand","Magnus Carlsen", "Bobby Fischer"], "correct_option": "Magnus Carlsen"},
            # Ďalšie otázky ...
        ]
